...
CONFIG_BOT_TOKEN = "8940424343:AAEyKkv34tm7uU97gcTcbp4aKuinQD7XIx8"
CONFIG_ZENEX_API_KEY = "ZNX_0L6V54ZNXOBN0I7LYN9IRV8M"
CONFIG_ZENEX_BASE_URL = "https://api.zenexnetwork.com"
CONFIG_ADMIN_ID = 6920894613
CONFIG_OTP_GROUP_ID = --1002180481770
...
BOT_TOKEN = os.getenv("8940424343:AAEyKkv34tm7uU97gcTcbp4aKuinQD7XIx8", "").strip() or CONFIG_BOT_TOKEN.strip()
...
OTP_GROUP_ID = int(os.getenv("OTP_GROUP_ID", str(CONFIG_OTP_GROUP_ID or "--1002180481770")))
...
async def fast_allocate_number(query, context, range_text, sid):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [InlineKeyboardButton("📢 OTP GROUP", url="https://t.me/httpsIncome_Insightbd_otp", style="primary")]
    ])
    try:
...
async def process_auto_number(update, context, range_text):
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("🔄 SAME RANGE", callback_data="same_range", style="primary")],
            [InlineKeyboardButton("📢 OTP GROUP", url="https://t.me/IncomeInsightbdotp", style="primary")]
        ])
...
async def process_numbers(update_or_query, context, range_text, count):
    ...
    try:
        ...
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("🔄 SAME RANGE", callback_data="same_range", style="primary")],
            [InlineKeyboardButton("📢 OTP GROUP", url="https://https://t.me/IncomeInsightbdotp", style="primary")]
        ])
...
async def check_force_join(update, context):
    ...
    text = (
        ...
        "<blockquote>বট ব্যবহার করতে আগে আমাদের চ্যানেলে জয়েন করুন।\n"
